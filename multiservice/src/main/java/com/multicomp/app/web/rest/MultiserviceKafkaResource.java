...
@RestController
@RequestMapping("/api/multiservice-kafka")
public class MultiserviceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MultiserviceKafkaResource.class);
    ...
    public MultiserviceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
